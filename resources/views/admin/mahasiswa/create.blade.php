				...
				<div class="col-md-6 col-sm-12">
					...
					<nav aria-label="breadcrumb" role="navigation">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Form Data Mahasiswa</li>
						</ol>
					</nav>
				</div>
			...
			<form action="{{ route('mahasiswa.store') }}" method="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-12 col-md-10">
						<input class="form-control" type="text" placeholder="Masukkan NIM" name="nim" value="{{ old('nim') }}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-12 col-md-2 col-form-label">Nama Lengkap</label>
					<div class="col-sm-12 col-md-10">
						<input class="form-control" placeholder="Nama Lengkap" type="text" name="nama_lengkap" value="{{ old('nama_lengkap') }}">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-12 col-md-10">
						<input class="form-control" placeholder="Tempat Lahir" type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-12 col-md-2 col-form-label">Tanggal Lahir</label>
					<div class="col-sm-12 col-md-10">
						<input class="form-control" placeholder="Masukkan Tanggal Lahir" type="date" name="tgl_lahir" value="{{ old('tgl_lahir') }}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-12 col-md-2 col-form-label">Alamat Lengkap</label>
					<div class="col-sm-12 col-md-10">
						<input class="form-control" placeholder="Alamat Lengkap" type="text" name="alamat" value="{{ old('alamat') }}">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-12 col-md-2 col-form-label">No HP</label>
					<div class="col-sm-12 col-md-10">
						<input class="form-control" placeholder="Nomor Handphone" type="text" name="no_hp" value="{{ old('no_hp') }}">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-12 col-md-10">
						<select class="custom-select col-12" name="jurusan">
							...
							<option value="Teknik Administrasi Niaga" {{ old('jurusan') == 'Teknik Administrasi Niaga' ? 'selected' : '' }}>Teknik Administrasi Niaga</option>
						</select>
					</div>
				</div>
				<div class="form-group row">
